  ...
  return (
    <div className="about">
      <div className="profile">
        <img className="about-image" src="profile.png" alt="plant" />
        <div className="about-profile">
          <div className="github">
            ...
            <a href="https://github.com/FadhilSulthan">Fadhil Sulthan</a>
          </div>
          ...
          <div className="instagram">
            ...
            <a href="https://www.instagram.com/fadhilsulthan_/">
              @fadhilsulthan_
            </a>
          </div>
        </div>
